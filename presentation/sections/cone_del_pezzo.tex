...
\begin{columns}[onlytextwidth]
    ...
    \begin{column}{0.49\textwidth}
        % Don't use a list unless there is more than one item
        %\begin{itemize}
	    %    \item
	        We can identify this component with $\P(\mathcal T_{\P^2}) \setminus H$, where $\T_{\P^2}$ is the tangent bundle of $\P^2\mkern-4mu$.
        %\end{itemize}
        \[
            \begin{vmatrix}
                 y  &  x_1    &  x_2    \\
